...
mcontainer.classList.add("container-fluid","d-flex","justify-content-center","align-items-center");
...
heading.classList.add("container-fluid","text-center","text-light","d-flex","justify-content-center","align-items-center");
